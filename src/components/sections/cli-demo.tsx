...
const demos = [
  ...
  },
  {
    ...
    title: "partio resume",
    lines: [
      { text: "partio resume a3f8c2d14e9b --print", type: "command" as const },
      { text: "", type: "output" as const },
      { text: "## Original Request", type: "accent" as const },
      { text: "Add user authentication with OAuth support", type: "output" as const },
      { text: "", type: "output" as const },
      { text: "## Plan", type: "accent" as const },
      { text: "1. Add OAuth provider configuration", type: "output" as const },
      { text: "2. Implement callback handler", type: "output" as const },
      { text: "3. Add session middleware", type: "output" as const },
      { text: "", type: "output" as const },
      { text: "## Changes Made", type: "accent" as const },
      { text: "+  src/auth/oauth.ts     | 47 lines", type: "success" as const },
      { text: "+  src/middleware/session.ts | 23 lines", type: "success" as const },
    ],
  },
];
